...
export const CT_UNIVERSE = [
  ...
  { ticker: '5333.T', name: 'NGK日本碍子',               sector: '電子部品・半導体' }, // セラミックパッケージ・半導体基板材料
  ...
  { ticker: '6269.T', name: '三井海洋開発',            sector: '重工業' }, // AI/半導体サプライチェーンとの連動性が低い（国策・レアアース採掘監視目的）
  ...
  { ticker: '5706.T', name: '三井金属鉱業',            sector: '非鉄金属' },
  { ticker: '5016.T', name: 'JX金属',                  sector: '非鉄金属' }, // OBV確立まで残り約4ヶ月（2024年9月上場）
